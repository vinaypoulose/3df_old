...
function onTrackerSubmit(timeStamp, responseId, submitter, idGoogleSheetUserFileConverted, urlUserFile) {
  ...
  const schoolDashboardUrl = "https://docs.google.com/spreadsheets/d/1ipHP8Lvzo99hiBdjwOPy8qj4Eo_cF-346LiOVZ3yMxc/edit";
...
function CreateGoogleSpreadSheet(userSubmittedTrackerId) {
  ...
  const tempFolderId = "1ngbyC_sE0RAiKFsf4kiZuRsYMXpPSjIM";
