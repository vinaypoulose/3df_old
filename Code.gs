...
function onTrackerSubmit(timeStamp, responseId, submitter, idGoogleSheetUserFileConverted, urlUserFile) {
  ...
  const schoolDashboardUrl = "https://docs.google.com/spreadsheets/d/1feQGvhnK9yBORDSy2pcMwsYLwt4qQJGnUuLVws1oTU0/edit";
...
function CreateGoogleSpreadSheet(userSubmittedTrackerId) {
  ...
  const tempFolderId = "1mwhlgOWVTLX7e0GWzTeDZPRIXhjBbG_l";
