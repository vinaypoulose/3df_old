...
function onTrackerSubmit(timeStamp, responseId, submitter, idGoogleSheetUserFileConverted, urlUserFile) {
  ...
  const schoolDashboardUrl = "https://docs.google.com/spreadsheets/d/103OXu4Kl2IAfFcw9Z-5e4cNjfA7sGiuIMe2cnIOZwak/edit";
...
function CreateGoogleSpreadSheet(userSubmittedTrackerId) {
  ...
  const tempFolderId = "1J8FSflZwzzOVIzVZZfBMd6VNc70q7zZZ";
