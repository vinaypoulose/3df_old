...
function onTrackerSubmit(timeStamp, responseId, submitter, idGoogleSheetUserFileConverted, urlUserFile) {
  ...
  const schoolDashboardUrl = "https://docs.google.com/spreadsheets/d/14o13AqDxB9L0GvQOfM3MMgnYgb--Ztjxd1T0azzWIck/edit";
...
function CreateGoogleSpreadSheet(userSubmittedTrackerId) {
  ...
  const tempFolderId = "17i-90AjqMZx5rqN45CgBUHrf2trFIKmR";
