...
function onTrackerSubmit(timeStamp, responseId, submitter, idGoogleSheetUserFileConverted, urlUserFile) {
  ...
  const schoolDashboardUrl = "https://docs.google.com/spreadsheets/d/1dc6DWCQLZrPWt5r6ELnQRQuBlrntflfoCh0Hb8xtAiA/edit";
...
function CreateGoogleSpreadSheet(userSubmittedTrackerId) {
  ...
  const tempFolderId = "1OFPJUeFwmFAP9J2cOgrCKlCmi-MQbkOB";
